...
import { FaLanguage, FaUsers, FaBookOpen, FaPlayCircle } from "react-icons/fa";
                ...
                <div className="hero-content text-center">
                    <div className="max-w-2xl">
                        ...
                        <div className="space-x-5">
                            <Link to='/learn'><button className="btn btn-neutral hover:bg-gray-800 rounded-full px-10 mb-20">Start Learning</button></Link>
